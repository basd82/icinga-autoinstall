...
```
curl https://raw.githubusercontent.com/basd82/icinga-autoinstall/mariadb/install-icinga2.sh -o install-director.sh;bash install-icinga2.sh;rm install-icinga2.sh
```
